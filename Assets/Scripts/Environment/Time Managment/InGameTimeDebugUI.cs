...
public class InGameTimeDebugUI : MonoBehaviour
{
    ...
    //     object currentDay = InGameTimeManager.Instance.GetCurrentSeason();
    ...
    //     bool dayChanged = (int)currentDay != lastDayOfSeason;


    //     if (showTime && timeChanged)
    //     {
    //         timeText.text = GetTimeString(currentTime);
    //         lastTimeOfDay = currentTime;
    //     }

    //     if (showDate && dayChanged)
    //     {
    //         dateText.text = GetDateString();
    //     }

    //     if (showSeason && dayChanged)
    //     {
    //         seasonText.text = GetSeasonString();
    //     }
    ...
    // {
    //     return $"Day {InGameTimeManager.Instance.GetCurrentDay()}";
    // }
    ...
    // {
    //     return $"Season {InGameTimeManager.Instance.GetCurrentSeason()}";
    // }
