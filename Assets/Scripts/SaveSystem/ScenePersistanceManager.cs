...
//     {
//         Debug.Log($"[ScenePersistenceManager]Preparing scene change to: {newSceneName}, FromSave: {isLoadingFromSaveFile}, Context: {saveContext}");
...
//     {
//         Debug.Log($"[ScenePersistanceManager] Collecting scene data for context: {context}");


//         if (persistentData == null)
//         {
//             Debug.LogError("[ScenePersistanceManager] Persistent data is not set! Cannot collect scene data.");
//             return;
//         }
...
//         {
//             Debug.Log($"[ScenePersistanceManager] Creating new SceneSaveData for scene: {currentScene}");
...
//                         savedObjectCount++;
//                         Debug.Log($"[ScenePersistanceManager] Saved player data for {saveable.SaveID} in context: {context}");
//                     }
//                 }
//                 else
//                 {
...
//                         sceneData.SetObjectData(saveable.SaveID, data);
//                         savedObjectCount++;
//                         Debug.Log($"[ScenePersistanceManager] Saved data for {saveable.SaveID} in context: {context}");
//                     }
//                 }
//             }
...
//         Debug.Log($"[ScenePersistanceManager] Collected scene data for: {currentScene} ({savedObjectCount} objects) with context: {context}");
//     }

//     private void RestoreSceneData(string sceneName, bool restorePlayerPosition = true)
//     {
//         if (persistentData?.sceneData?.ContainsKey(sceneName) != true)
//         {
//             Debug.LogWarning($"[ScenePersistanceManager] No scene data found for scene: {sceneName}");
//             return;
//         }
...
//     {
//         Debug.Log($"[ScenePersistanceManager] Restoring scene data for: {sceneData.sceneName}, RestorePlayerPosition: {restorePlayerPosition}");
